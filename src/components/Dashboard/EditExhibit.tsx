                ...
                {translations.map((translation, index) =>(
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setTranslations(translations.map((item, i) => i === index ? {...item, title: e.target.value} : item))}
                    />
                  </div>
                </div>
                ))
            ...
            {translations.map((translation, index) => (
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={(e) => setTranslations(translations.map((item, i) => i === index ? {...item, description: e.target.value} : item ))}
                ></textarea>
              </div>
