...
const ClientVisitorTable = () => {
  ...
  useEffect(() => {
    const fetchVisitors = async () => {
      try {
        const response = await api.get("api/client/get-visitor-data", {
          headers: {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="flex justify-between mb-5">
        <h2 className="text-lg font-medium text-black dark:text-white">Your Visitors</h2>
      </div>
...
export default ClientVisitorTable;