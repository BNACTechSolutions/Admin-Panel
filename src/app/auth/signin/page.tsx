  ...
  return (
    ...
    <div className="h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="flex flex-wrap items-center">
        ...
        <div onClick={handleAdminPortal} className="flex justify-end pr-10 hover: cursor-pointer">Sign in to Admin Portal <Icon icon="mdi:arrow-right" width="24" height="24" /> </div>
