...
const SignIn: React.FC = () => {
  ...
  const handleSignIn = async () => {
    ...
    if (!executeRecaptcha) {
      notifyError("reCAPTCHA not ready. Please try again.");
      return;
    }
    ...
    <div className="min-h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="hidden lg:block lg:w-1/2 xl:w-2/5">
          <div className="px-4 py-8 lg:px-8 xl:px-12 lg:py-12 h-full flex flex-col">
        ...
        <div className="w-full lg:w-1/2 xl:w-3/5 border-stroke dark:border-strokedark lg:border-l-2">
          <div onClick={handleAdminPortal} className="flex justify-end p-4 hover:cursor-pointer">
            Sign in to Admin Portal <Icon icon="mdi:arrow-right" className="ml-2" width="24" height="24" />
          </div>
          
          <div className="w-full p-4 sm:p-8 lg:p-12 xl:p-16">
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <Link href={"/auth/forgot-password"}>
                    <div className="px-2 pt-1 text-sm">Forgot password?</div>
                  </Link>
